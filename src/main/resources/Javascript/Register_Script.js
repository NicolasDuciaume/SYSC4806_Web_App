function myFunction() {
    ...
    if((pass.length > 6) && (format.test(pass)) && (format2.test(pass))){
        $.ajax({
            type: "GET",
            url: "https://projectsysc4806.herokuapp.com/rest/api/user/get/" + document.getElementById("username").value,
...
function createFunction(){
    $.ajax({
        type: "POST",
        url: "https://projectsysc4806.herokuapp.com/rest/api/user/add",
        contentType : "application/json",
